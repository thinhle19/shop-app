...
class _AuthCardState extends State<AuthCard>
  ...
  void initState() {
    ...
    //vsync: pointer to what is visible to user's screen and u need to animate
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      //this will cause us at auth screen always
      // Navigator.of(context).pushReplacementNamed("/product-overview");
    } on HttpException catch (error) {
      //you can add more, like mail not exist, password invalid ...
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: /* AnimatedBuilder(
        ...
        builder: (ctx, ch) => */ /* Container */ AnimatedContainer(
